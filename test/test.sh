...
rm -rf ansible-push-keys
ansible-playbook setup.yaml --limit "oob-mgmt-server"
ansible-playbook setup.yaml --limit "leafs"
ansible-playbook setup.yaml --limit "spines"
ansible-playbook setup.yaml --limit "servers"
