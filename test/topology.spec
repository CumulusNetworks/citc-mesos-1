...
vm leaf03 cumulus-vx-3.3.2 1 2 2 
vm leaf04 cumulus-vx-3.3.2 1 2 2
...
service oob-mgmt-server ssh 192.168.0.254 22 TCP public
service oob-mgmt-server http 192.168.0.254 80 TCP public
service oob-mgmt-server https 192.168.0.254 443 TCP public
service oob-mgmt-server http2 192.168.0.254 1337 TCP public
service oob-mgmt-server grafana 192.168.0.254 3000 TCP public
service oob-mgmt-server novnc 192.168.0.254 6080 TCP public
service oob-mgmt-server netq 192.168.0.254 9000 TCP public
service oob-mgmt-server mesos 192.168.0.254 5050 TCP public
service oob-mgmt-server marathon 192.168.0.254 8080 TCP public
service oob-mgmt-server mesosapp 192.168.0.254 8088 TCP public
